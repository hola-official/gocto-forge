...
const Count = () => {
  ...
  return (
    <section className="count">
      ...
      {incrementError && (
        <p style={{ color: 'red' }}>
          Increment Error: {incrementError.shortMessage || incrementError.message}
        </p>
      )}
      {decrementError && (
        <p style={{ color: 'red' }}>
          Decrement Error: {decrementError.shortMessage || decrementError.message}
        </p>
      )}
      {resetError && (
        <p style={{ color: 'red' }}>
          Reset Error: {resetError.shortMessage || resetError.message}
        </p>
      )}
